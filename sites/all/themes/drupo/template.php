...
*/
/*function drupo_preprocess_user_profile(&$variables) {
...
/*
 * Замена табов на контекстные ссылки
 */ 
/*
function drupo_menu_local_task($variables) {
...
function drupo_menu_local_tasks($variables) {
...
*/
function drupo_preprocess_page(&$variables, $hook) {
